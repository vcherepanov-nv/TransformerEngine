 ...
 *  \param[in]     score_mod                 Optional Python callable (PyObject*) for custom attention score modification. Cast to void* for C API compatibility. Only supported in the cuDNN fused attention backend.
 ...
 *  \param[in]     cuda_graph                Whether cuda graph capture is enabled or not.
 *  \param[in]     score_mod                 Optional Python callable (PyObject*) for custom attention score modification in forward. Cast to void* for C API compatibility. Only supported in the cuDNN fused attention backend.
 *  \param[in]     score_mod_bprop           Optional Python callable (PyObject*) for custom attention score modification in backward. Cast to void* for C API compatibility. Only supported in the cuDNN fused attention backend.
 *  \param[in]     workspace                 Workspace tensor.
 *  \param[in]     stream                    CUDA stream used for this operation.
 */
